...
class ActivationFunction {
  ...
  class Perceptron {
     ...
     * @param {Function} activationFunction The activation function to use.
     */
  ...
  class Layer {
     ...
     * @param {Function} activationFunction The activation function to use.
     */
    constructor(layerSize, percSize, activationFunction = sigmoid) {
  ...
  class NeuralNetwork {
    ...
    constructor(params) {
      ...
      this.activation = params.activationFunction || sigmoid;
    }
